  ...
  <EntitySwitch>
    <EntitySwitch.Case>
      <EmptyState
        ...
        missing="info"
        description="You need to add an annotation to your component if you want to enable CI/CD for it. You can read more about annotations in OneMind by clicking the button below."
        action={
          <Button
            variant="contained"
            color="primary"
